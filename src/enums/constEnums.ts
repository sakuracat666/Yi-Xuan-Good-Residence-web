...
export const PaymentStatusMap = [
  { label: '待支付', value: PaymentStatus.WAITING },
  { label: '已支付', value: PaymentStatus.SUCCESS },
  { label: '已关闭', value: PaymentStatus.CLOSED },
  { label: '已退款', value: PaymentStatus.REFUNDED },
]

// 支付方式组合枚举
export enum PayMethodCombination {
  NOT_SELECTED = 0,
  BALANCE_ONLY = 1,
  WECHAT_ONLY = 2,
  MIXED = 3,
}
export const PayMethodCombinationMap = [
  { label: '未选择', value: PayMethodCombination.NOT_SELECTED },
  { label: '纯余额', value: PayMethodCombination.BALANCE_ONLY },
  { label: '纯微信', value: PayMethodCombination.WECHAT_ONLY },
  { label: '混合支付', value: PayMethodCombination.MIXED },
]

// 退款状态枚举：0无退款 1退款中 2已退款 3退款失败
...
export const RefundStatusMap = [
  { label: '无退款', value: RefundStatus.NONE },
  { label: '退款中', value: RefundStatus.PROCESSING },
  { label: '已退款', value: RefundStatus.SUCCESS },
...
export const RepairStatusMap = [
  { label: '待处理', value: RepairStatus.PENDING },
  { label: '处理中', value: RepairStatus.PROCESSING },
  { label: '已完成', value: RepairStatus.COMPLETED },
  { label: '已取消', value: RepairStatus.CANCELLED },
]
// 报修优先级,可用值:1,2,3
...
export const RepairPriorityMap = [
  { label: '低', value: RepairPriority.LOW },
  { label: '中', value: RepairPriority.MEDIUM },
  { label: '高', value: RepairPriority.HIGH },
]
